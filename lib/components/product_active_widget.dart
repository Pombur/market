...
import 'product_active_model.dart';
export 'product_active_model.dart';

class ProductActiveWidget extends StatefulWidget {
...
class _ProductActiveWidgetState extends State<ProductActiveWidget>
  ...
  late ProductActiveModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProductActiveModel());
                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    valueOrDefault<String>(
                                      columnTextContentRow?.productActive,
                                      '#',
                                    ),
