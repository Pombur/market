...
class _NotificationWidgetState extends State<NotificationWidget> {
  ...
  void initState() {
    ...
    _model.imgController ??= TextEditingController();
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsetsDirectional.fromSTEB(8.0, 10.0, 8.0, 0.0),
              child: TextFormField(
                controller: _model.imgController,
                ...
                style: FlutterFlowTheme.of(context).bodyMedium,
                validator: _model.imgControllerValidator.asValidator(context),
              ),
            ),
            Flexible(
              child: Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    await NotificationTable().insert({
                      ...
                      'image': _model.imgController.text,
                    });
