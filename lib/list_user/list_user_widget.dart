                ...
                child: Padding(
                  ...
                  child: FutureBuilder<List<UserInfoRow>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<UserInfoRow> listViewUserInfoRowList =
                          snapshot.data!;
                      return ListView.builder(
                        padding: EdgeInsets.zero,
                        scrollDirection: Axis.vertical,
                        itemCount: listViewUserInfoRowList.length,
                        itemBuilder: (context, listViewIndex) {
                          final listViewUserInfoRow =
                              listViewUserInfoRowList[listViewIndex];
                          return Builder(
                            builder: (context) => Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  await showDialog(
                                    barrierColor: const Color(0x96606A85),
                                    context: context,
                                        ...
                                        ClipRRect(
                                          ...
                                          child: Image.network(
                                            valueOrDefault<String>(
                                              listViewUserInfoRow.image,
                                              'https://kctvhrmzireulhshjrqh.supabase.co/storage/v1/object/public/abi/avatar_empt.png',
                                            ),
                                            width: 60.0,
                                            height: 60.0,
                                            fit: BoxFit.cover,
