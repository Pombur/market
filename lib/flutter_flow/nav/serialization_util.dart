  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case WellsViewRow:
            return WellsViewRow(data);
          case UserInfoRow:
            return UserInfoRow(data);
          case WellsRow:
            return WellsRow(data);
          case OrderViewRow:
            return OrderViewRow(data);
          case OrderItemsViewRow:
            return OrderItemsViewRow(data);
          case TextContentRow:
            return TextContentRow(data);
          case OrderItemsRow:
          ...
          case WellsSummaryRow:
            return WellsSummaryRow(data);
          case CategoriesRow:
            return CategoriesRow(data);
          case ProductRow:
            return ProductRow(data);
          case ProductDetailViewRow:
            return ProductDetailViewRow(data);
          default:
            return null;
        }
