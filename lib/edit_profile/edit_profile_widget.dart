...
class _EditProfileWidgetState extends State<EditProfileWidget> {
  ...
  void initState() {
    ...
    _model.textController2 ??=
        TextEditingController(text: widget.profileDate?.name);
    ...
    _model.textController4 ??=
        TextEditingController(text: widget.profileDate?.country);
    _model.textFieldFocusNode4 ??= FocusNode();

    _model.textController5 ??=
        TextEditingController(text: widget.profileDate?.city);
    _model.textFieldFocusNode5 ??= FocusNode();

    _model.textController6 ??=
        TextEditingController(text: widget.profileDate?.team);
    _model.textFieldFocusNode6 ??= FocusNode();

    _model.textController7 ??=
        TextEditingController(text: widget.profileDate?.about);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: const Color(0xC315161E),
            ...
            children: [
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    _model.updateUserInfo = await UserInfoTable().update(
                      data: {
                        ...
                        'team': _model.textController6.text,
                        'phoneNum':
