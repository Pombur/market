...
import 'map_poi_model.dart';
export 'map_poi_model.dart';
...
class _MapPoiWidgetState extends State<MapPoiWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MapPoiModel());
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              Expanded(
                child: FutureBuilder<List<WellsRecord>>(
                  future: queryWellsRecordOnce(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<WellsRecord> googleMapWellsRecordList = snapshot.data!;
