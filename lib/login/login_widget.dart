                          ...
                          Padding(
                            ...
                            child: FutureBuilder<List<TextContentRow>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<TextContentRow>
                                    containerTextContentRowList =
                                    snapshot.data!;
                                final containerTextContentRow =
                                    containerTextContentRowList.isNotEmpty
                                        ? containerTextContentRowList.first
                                        : null;
                                return Container(
                                  width: double.infinity,
                                  height:
                                                          ...
                                                          padding:
                                                              const EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      24.0),
                                                          child: Text(
                                                            containerTextContentRow.login2,
                                                            textAlign:
                                                                TextAlign.start,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
