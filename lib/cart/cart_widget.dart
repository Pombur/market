...
class _CartWidgetState extends State<CartWidget> {
  ...
  void initState() {
    ...
    _model.inputNotesController ??= TextEditingController();
    _model.inputNotesFocusNode ??= FocusNode();
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<UserInfoRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserInfoRow> cartUserInfoRowList = snapshot.data!;
        final cartUserInfoRow =
            cartUserInfoRowList.isNotEmpty ? cartUserInfoRowList.first : null;
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            body: Stack(
              children: [
                if (FFAppState().shopingCart.isNotEmpty)
                  Column(
                            ...
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    15.0, 0.0, 15.0, 0.0),
                                child: TextFormField(
                                  controller: _model.inputNotesController,
                                  focusNode: _model.inputNotesFocusNode,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    labelText: 'Коментарий к заказу... ',
                                    labelStyle:
                                        FlutterFlowTheme.of(context).bodyMedium,
                                    hintText:
                                        'При заказе, профиль должен быть заполнен.',
                                      ...
                                      child: Container(
                                        ...
                                        child:
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            List<TextContentRow>
                                                rowTextContentRowList =
                                                snapshot.data!;
                                            final rowTextContentRow =
                                                rowTextContentRowList.isNotEmpty
                                                    ? rowTextContentRowList
                                                        .first
                                                    : null;
                                            return Row(
                ...
                if (FFAppState().shopingCart.isEmpty)
                  Column(
                    mainAxisSize: MainAxisSize.max,
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                'Выбирайте товары и добавляйте их в корзину',
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context)
                                    .bodySmall
                                    .override(
